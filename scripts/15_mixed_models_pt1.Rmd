...
We can use the `{performance}` package to check our model assumptions. Note, we expect to see our residuals being normally distributed (as is the case with linear models).
